...
# returns the extesion of a file
...
def determineCharset(option):
    options = {"lowercase":string.ascii_lowercase, "uppercase":string.ascii_uppercase, "allcase":string.ascii_letters, "digits":string.digits,"alphanumeric":string.ascii_letters+string.digits}
    return options.get(option,string.ascii_letters+string.digits)

# Arguments parser
parser = argparse.ArgumentParser()
#parser.add_argument('--path','-p', type=str, help='Path to the directory [Defaults to the current directory]')
...
user.add_argument('--path','-p', type=str, help='Path to the directory [Defaults to the current directory]')
...
rand.add_argument('--charset', '-c', type = str, help='Things to include in the file name',choices=['lowercase','uppercase','allcase','alphanumeric','digits'])
rand.add_argument('--path','-p', type=str, help='Path to the directory [Defaults to the current directory]')
